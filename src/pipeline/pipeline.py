...
from src.entity.artifact_entity import DataIngestionArtifact, ModelPusherArtifact
...
class Pipeline(Thread):
    ...
    def start_model_pusher(self, model_train_artifact: ModelTrainerArtifact, 
        ...
        try:
            model_pusher = ModelPusher(
                ...
                model_trainer_artifact=model_train_artifact,
    ...
    def run_pipeline(self):
        try:
            ...
            model_pusher_artifact = self.start_model_pusher(model_train_artifact=model_trainer_artifact, 
            ...
            Pipeline.experiment = Experiment(experiment_id=Pipeline.experiment.experiment_id,
                                             ...
                                             experiment_file_path=Pipeline.experiment_file_path,
                                             is_model_accepted=model_trainer_artifact.is_trained,
