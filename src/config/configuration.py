...
class Configuartion:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            data_transformation_config_info[DATA_SCHEMA_DIR_KEY],
            data_transformation_config_info[DATA_SCHEMA_FILE_NAME_KEY]
            )
            ...
            data_transformation_config=DataTransformationConfig(transformed_data_dir= transformed_data_dir, schema_file_path=schema_file_path)
